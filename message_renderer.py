...
class MessageRenderer:
    ...
    def _create_message_list(self):
        ...
        messages = [
            ...
            {"text": "Hope this isnt a bad time", "start": 72, "duration": 4, "pause": 0},
            {"text": "Hope you feeling better now", "start": 78, "duration": 4, "pause": 0},
            ...
            {"text": "Band karde kuch ni hai \niske baad", "start": 161, "duration": 3, "pause": 3},
            ...
            {"text": "I have fun whenever im with you\nGenuinely", "start": 239, "duration": 4, "pause": 0},
            {"text": "I like being with you", "start": 244, "duration": 3, "pause": 0},
            {"text": "We both have our differences", "start": 248, "duration": 2, "pause": 0},
            ...
            {"text": "Looks cool not even kidding", "start": 285, "duration": 2, "pause": 0},
            {"text": "Mine not yours", "start": 288, "duration": 2, "pause": 0},
            {"text": "Yours too 👁️👅👁️", "start": 293, "duration": 2, "pause": 0},
            ...
            {"text": "You matter to me", "start": 347, "duration": 3, "pause": 0},
            {"text": "Hope you know that", "start": 353, "duration": 2, "pause": 0},
            {"text": "Thanks for being here", "start": 357, "duration": 2, "pause": 0},
            {"text": "As will i be", "start": 360, "duration": 1.5, "pause": 0},
            
            {"text": "Got too sweet shit", "start": 366, "duration": 1.5, "pause": 0},
            {"text": "Lmao tu end tak hai", "start": 369, "duration": 1.5, "pause": 0},
            {"text": "Hope you liked it", "start": 372, "duration": 1.5, "pause": 0},
            {"text": "Double sided tape bhi dede\nabhi yaad aaya ;-;", "start": 375, "duration": 4, "pause": 0},
            {"text": "Chal ab band karde", "start": 380, "duration": 1.5, "pause": 0},
